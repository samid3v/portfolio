...
export default function Projects() {
  const projects = [
    ...
    },
    {
      ...
      tags: ["CRM", "Properties", "Finance", "Analytics"],
    ...
    {
      title: "Pet Farm Clinic",
      description: "Pet clinic management system with patient boarding, invoice tracking, analytics, vaccines, and services management.",
