...
export default function Experience() {
  const experiences = [
    {
      title: "Software Engineer & IT Systems Lead",
      company: "Rehan Properties",
      period: "April 2024 - Present",
      location: "Kenya",
      description: "Designed and maintained company website with CRM integration and analytics tracking. Deployed AWS-based cloud services for automation and data storage. Developed internal tools to streamline communication and system management. Integrated PBX and CCTV systems into a unified digital workflow. Advised management on technology upgrades and software adoption.",
      achievements: ["CRM Integration", "AWS Cloud Deployment", "PBX & CCTV Integration"],
    ...
    },
    {
      ...
      location: "Kenya",
      description: "Taught backend and full-stack web development (Python, PHP, JavaScript). Mentored students in software projects and version control practices. Guided learners on real-world system design and automation logic.",
      achievements: ["Taught 50+ students", "Mentored projects", "Curriculum development"],
    ...
    },
    {
      ...
      location: "Kenya",
      description: "Built and maintained high-performance eCommerce and marketing websites. Improved UI/UX designs and implemented SEO optimization. Collaborated on integrating analytics, CRM, and chatbots into business sites. Provided backend support and implemented system updates.",
      achievements: ["Built eCommerce sites", "SEO Optimization", "CRM Integration"],
      color: "from-purple-500 to-indigo-500",
    },
    {
      title: "Software Developer",
      company: "Asoko Engineers",
      period: "Feb 2021 - Sept 2021",
      location: "Kenya",
      description: "Developed internal and client-facing web applications. Implemented innovative software modules based on project specifications. Handled full-cycle coding, testing, and deployment of web systems.",
      achievements: ["Developed web apps", "Full-cycle development", "Client projects"],
